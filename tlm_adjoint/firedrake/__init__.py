...
del backend, backend_code_generator_interface, backend_interface, assembly, \
    assignment, block_system, caches, equations, expr, functions, \
    hessian_system, interpolation, parameters, projection, \

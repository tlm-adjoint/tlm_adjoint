        ...
        def __init__(self, U, h, initial_guess = None):
            ...
            EquationSolver.__init__(self, F == 0, U, initial_guess = initial_guess,
                solver_parameters = {"ksp_type":"cg",
                                                         ...
                                                         "mat_type":"aij"},  # Used by adjoint/tangent-linear
...
#      info("%s J_1 form compiler parameters: %s" % (self.x().name(), form_form_compiler_parameters(self._J_1, parameters["form_compiler"])))
        ...
        def forward_solve(self, x, deps = None):
            ...
            solve(F == 0, U, J = J_1, solver_parameters = {"snes_type":"newtonls",
                                                                                                         "ksp_type":"cg",
                                                                                                         "pc_type":"hypre",
                                                                                                         "pc_hypre_type":"boomeramg",
                                                                                                         "ksp_rtol":1.0e-12, "ksp_atol":1.0e-16,
                                                                                                         "snes_rtol":0.0, "snes_atol":max(1.0e-16, 1.0e-4 * r_norm),
                                                                                                         "snes_max_it":100,
                                                                                                         "snes_error_if_not_converged":False,
                                                                                                         "mat_type":"aij"},
                                                                form_compiler_parameters = self._form_compiler_parameters)
            solve(F == 0, U, J = J_2, solver_parameters = {"snes_type":"newtonls",
                                                                                                         "ksp_type":"cg",
                                                                                                         "pc_type":"hypre",
                                                                                                         "pc_hypre_type":"boomeramg",
                                                                                                         "ksp_rtol":1.0e-12, "ksp_atol":1.0e-16,
                                                                                                         "snes_rtol":0.0, "snes_atol":max(1.0e-16, min(1.0e3, 1.0e-11 * r_norm)),
                                                                                                         "snes_max_it":10,

...
class tests(unittest.TestCase):
  ...
  def test_higher_order_adjoint(self):
    ...
    perturb1 = Function(space, name = "perturb1", static = True)
    function_assign(perturb1, perturb)
    perturb2 = Function(space, name = "perturb2", static = True)
    function_assign(perturb2, perturb)
    perturb3 = Function(space, name = "perturb3", static = True)
    function_assign(perturb3, perturb)
    
    add_tlm(kappa, perturb1)
    add_tlm(kappa, perturb2)
    add_tlm(kappa, perturb3)
    start_manager()
    J = forward(kappa)
    dJ_tlm = J.tlm(kappa, perturb1)
    ddJ_tlm = dJ_tlm.tlm(kappa, perturb2)
    dddJ_tlm = ddJ_tlm.tlm(kappa, perturb3)
    stop_manager()
  ...
  def test_timestepping(self):    
    for n_steps in [1, 2, 5, 20]:
      ...
      self.assertGreaterEqual(min_order, 1.99)
  ...
  def test_second_order_adjoint(self):    
    ...
    self.assertGreaterEqual(min_order, 2.99)

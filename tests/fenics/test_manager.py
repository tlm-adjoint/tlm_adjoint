...
def test_adjoint_caching(setup_test, test_leaks):
    ...
    assert abs(dJ_0b - var_inner(dm_0, dJ_0)) < 1.0e-16
    ...
    assert var_linf_norm(dK_error) < 1.0e-18
    ...
    assert var_linf_norm(dddJ_error) < 1.0e-19
    ...
    assert var_linf_norm(dddJ_error) < 1.0e-22
